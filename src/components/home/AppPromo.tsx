        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <ul className="space-y-3 mb-10">
              {features.map(({ icon: Icon, text }) => (
                <li key={text} className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-lg bg-brand-50 border border-brand-100 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-wrap gap-3">
              <button className="flex items-center gap-3 px-5 py-3 rounded-xl bg-slate-100 border border-slate-200 text-slate-900 hover:bg-slate-200 transition-colors">
          ...
          >
            <div className="relative">
              {/* Glow */}
              <div className="absolute inset-0 bg-brand-400/20 blur-3xl rounded-full scale-75" />
              ...
              <div className="relative w-56 h-[460px] rounded-[36px] border-2 border-zinc-700 bg-zinc-900 shadow-2xl overflow-hidden">
                ...
                <div className="absolute inset-1 rounded-[32px] bg-zinc-900 overflow-hidden">
                  ...
                  {/* App header */}
                  <div className="px-4 py-3 bg-brand-600">
              ...
              <motion.div
                className="absolute -right-8 top-20 bg-white rounded-xl shadow-xl p-2.5 flex items-center gap-2 border border-slate-200"
                animate={{ y: [0, -6, 0] }}
              ...
              >
                ...
                <div>
                  <div className="text-[10px] font-semibold text-slate-900">Lucrare finalizată!</div>
