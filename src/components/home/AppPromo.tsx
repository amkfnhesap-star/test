...
const features = [
  ...
  { icon: Star, text: "Leave reviews in-app" },
  { icon: CheckCircle, text: "Job progress updates" },
];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg mb-8 leading-relaxed">
              The SkillSeekers app puts 250,000+ professionals at your fingertips.
              Book, track, and review from your phone in seconds.
            </p>
            ...
            <p className="text-zinc-600 text-xs mt-4">
              Join 50,000+ users on the waitlist. Early access coming Q2 2025.
            </p>
          </motion.div>
          ...
          >
            <div className="relative">
                ...
                <div className="absolute inset-1 rounded-[32px] bg-zinc-900 overflow-hidden">
                  ...
                  <div className="px-4 py-3 bg-gradient-to-r from-brand-600 to-violet-700">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white text-sm font-semibold">SkillSeekers</span>
                    </div>
                    <div className="bg-white/15 rounded-xl px-3 py-2 flex items-center gap-2">
                      <div className="h-3 w-3 bg-white/50 rounded-sm" />
                      <span className="text-white/70 text-[10px]">Search services...</span>
                    </div>
                  </div>
                  ...
                  <div className="px-3 py-3 space-y-2">
                    {[
                      { name: "Marcus J.", cat: "Handyman", rating: "4.9", price: "$65/hr", color: "from-red-500 to-rose-600" },
                      { name: "Sophia C.", cat: "Cleaning", rating: "4.95", price: "$120", color: "from-blue-500 to-cyan-600" },
                      { name: "Emma W.", cat: "Pet Care", rating: "4.98", price: "$35/hr", color: "from-pink-500 to-rose-600" },
                    ].map((p) => (
                      <div
                        key={p.name}
              ...
              >
                ...
                <div>
                  <div className="text-[10px] font-semibold text-zinc-900 dark:text-white">Job Completed!</div>
                  <div className="text-[9px] text-zinc-400">Marcus is on his way</div>
                </div>
              </motion.div>
            </div>
          </motion.div>
